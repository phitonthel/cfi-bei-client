...
const createText = (authUser) => {
  if (authUser.level === 'Kepala Divisi') {
    return 'Nominate 2-5 Kepala Unit and 3 KK/Spesialis/Staf.'
  }

  if (authUser.level === 'Kepala Unit') {
    return 'Nominate 2-4 KK/Spesialis/Staf.'
  }

  if (authUser.level === 'Kepala Kantor') {
    return 'Nominate 2 Trainer or Staf Administrasi Kantor Perwakilan.'
  }
}
